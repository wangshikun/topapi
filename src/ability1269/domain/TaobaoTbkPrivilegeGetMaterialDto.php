...
class TaobaoTbkPrivilegeGetMaterialDto {
    ...
    public function getTopnInfo() : TaobaoTbkPrivilegeGetStepRateDto{
        return $this->topn_info;
    }

    public function setTopnInfo(TaobaoTbkPrivilegeGetStepRateDto $topnInfo){
        $this->topn_info = $topnInfo;
    }

    public function getMiniProgram() : TaobaoTbkPrivilegeGetMiniProgramDto{
        return $this->mini_program;
    }

    public function setMiniProgram(TaobaoTbkPrivilegeGetMiniProgramDto $miniProgram){
