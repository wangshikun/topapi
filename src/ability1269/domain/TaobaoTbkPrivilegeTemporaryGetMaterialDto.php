...
class TaobaoTbkPrivilegeTemporaryGetMaterialDto {
    ...
    public function getTopnInfo() : TaobaoTbkPrivilegeTemporaryGetStepRateDto{
        return $this->topn_info;
    }

    public function setTopnInfo(TaobaoTbkPrivilegeTemporaryGetStepRateDto $topnInfo){
        $this->topn_info = $topnInfo;
    }

    public function getMiniProgram() : TaobaoTbkPrivilegeTemporaryGetMiniProgramDto{
        return $this->mini_program;
    }

    public function setMiniProgram(TaobaoTbkPrivilegeTemporaryGetMiniProgramDto $miniProgram){
