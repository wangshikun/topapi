...
class TaobaoTbkScMaterialOptionalUpgradePublishInfo {
    ...
    public function getTopnInfo() : TaobaoTbkScMaterialOptionalUpgradeTopNInfoDTO{
        return $this->topn_info;
    }

    public function setTopnInfo(TaobaoTbkScMaterialOptionalUpgradeTopNInfoDTO $topnInfo){
    ...
    public function getIncomeInfo() : array{
        return $this->income_info;
    }

    public function setIncomeInfo(array $incomeInfo){
