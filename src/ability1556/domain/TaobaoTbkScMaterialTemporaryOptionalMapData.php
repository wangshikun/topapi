...
class TaobaoTbkScMaterialTemporaryOptionalMapData {
    ...
    public function getLocalizationExtend() : array{
        return $this->localization_extend;
    }

    public function setLocalizationExtend(array $localizationExtend){
    ...
    public function getTopnInfo() : TaobaoTbkScMaterialTemporaryOptionalTopNInfoDTO{
        return $this->topn_info;
    }

    public function setTopnInfo(TaobaoTbkScMaterialTemporaryOptionalTopNInfoDTO $topnInfo){
        $this->topn_info = $topnInfo;
    }

    public function getBybtInfo() : TaobaoTbkScMaterialTemporaryOptionalBybtInfoDTO{
        return $this->bybt_info;
    }

    public function setBybtInfo(TaobaoTbkScMaterialTemporaryOptionalBybtInfoDTO $bybtInfo){
    ...
    public function getMaifanPromotion() : TaobaoTbkScMaterialTemporaryOptionalMaifanPromotionDTO{
        return $this->maifan_promotion;
    }

    public function setMaifanPromotion(TaobaoTbkScMaterialTemporaryOptionalMaifanPromotionDTO $maifanPromotion){
