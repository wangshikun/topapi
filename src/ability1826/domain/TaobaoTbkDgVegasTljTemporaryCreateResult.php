...
class TaobaoTbkDgVegasTljTemporaryCreateResult {
    ...
    public function getModel() : TaobaoTbkDgVegasTljTemporaryCreateRightsInstanceCreateResult{
        return $this->model;
    }

    public function setModel(TaobaoTbkDgVegasTljTemporaryCreateRightsInstanceCreateResult $model){
        $this->model = $model;
    }
