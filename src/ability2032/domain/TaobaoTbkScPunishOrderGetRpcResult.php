<?php
namespace Topsdk\Topapi\Ability2032\Domain;

class TaobaoTbkScPunishOrderGetRpcResult {
    ...
    public function getData() : TaobaoTbkScPunishOrderGetPageResult{
        return $this->data;
    }

    public function setData(TaobaoTbkScPunishOrderGetPageResult $data){
        $this->data = $data;
    }
