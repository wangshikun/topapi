...
class TaobaoTbkDgMaterialTemporaryOptionalMapData {
    ...
    public function getTopnInfo() : TaobaoTbkDgMaterialTemporaryOptionalStepRateDTO{
        return $this->topn_info;
    }

    public function setTopnInfo(TaobaoTbkDgMaterialTemporaryOptionalStepRateDTO $topnInfo){
        $this->topn_info = $topnInfo;
    }

    public function getBybtInfo() : TaobaoTbkDgMaterialTemporaryOptionalTopNInfoDTO{
        return $this->bybt_info;
    }

    public function setBybtInfo(TaobaoTbkDgMaterialTemporaryOptionalTopNInfoDTO $bybtInfo){
    ...
    public function getMaifanPromotion() : TaobaoTbkDgMaterialTemporaryOptionalMaifanPromotionDTO{
        return $this->maifan_promotion;
    }

    public function setMaifanPromotion(TaobaoTbkDgMaterialTemporaryOptionalMaifanPromotionDTO $maifanPromotion){
